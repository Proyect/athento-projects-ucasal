#!/usr/bin/env python
"""
Script de configuración inicial del proyecto UCASAL
"""
import os
import sys
import subprocess
...
""")
    ...
    if not run_command("python manage.py check", "Verificando configuración de Django"):
        print("⚠️  Se encontraron problemas en la configuración, pero continuando...")
    ...
    try:
        ...
        print(f"⚠️  No se pudo verificar/crear superusuario: {e}")
